...
> **"주문부터 배송, 재무, 마케팅까지 사람의 개입 없이(Human-in-the-loop Free) 24시간 작동하는 무인 자동화 시스템"** [cite: 8, 363, 693]

---

## 📌 1. 프로젝트 개요
* **프로젝트명:** 주문부터 배송까지: 쇼핑몰 운영 자동화
* **핵심 목표:** 1인 사업자의 과중한 반복 업무(매입·판매·영업) 부하를 해소하고, 모바일 환경에서 주문부터 알림까지 원스톱으로 처리 가능한 자동화 시스템 구축
